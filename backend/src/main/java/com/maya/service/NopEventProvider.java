...
public class NopEventProvider implements EventProvider {
    private final EventMapper eventMapper;

    public NopEventProvider(EventMapper eventMapper) {
        this.eventMapper = eventMapper;
    }

    public List<Event> fetchEvents2(String q) {
    ...
    public List<Event> fetchEvents(String q) {
        String jsonAsString = """
                ...
                """;
        return eventMapper.map(jsonAsString);
    }
}
